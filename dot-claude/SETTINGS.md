...
| `autoMode.environment` | Prose context for the classifier: which orgs and cloud surfaces this machine legitimately touches. User scope only; it is ignored in project settings. |
