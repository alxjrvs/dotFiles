---
name: guard-tester
description: Run every guard suite in this dotfiles repo and report only what failed, with the failing case and its command. Use after changing anything under home/dot_claude/hooks/ or scripts/.
...
home/dot_claude/hooks/tests/all.sh
```
